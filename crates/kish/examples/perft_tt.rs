//! Perft with transposition table example.
//!
//! Run with: `cargo run --release --example perft_tt`
...
fn main() {
    println!("=== Perft with Transposition Table ===\n");
    ...
    for &(depth, expected) in PERFT_VALUES {
        ...
        let nodes = board.perft_tt(depth, TT_SIZE_MB);
